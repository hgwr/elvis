...
#define M_ATCURSOR	261		/* internal code for \@ */
#define M_SPLAT		262		/* internal code for * */
#define M_PLUS		263		/* internal code for \+ */
#define M_QMARK		264		/* internal code for \? */
#define M_RANGE		265		/* internal code for \{ */
#define M_CLASS(n)	(266+(n))	/* internal code for [] */
#define M_START(n)	(276+(n))	/* internal code for \( */
#define M_END(n)	(286+(n))	/* internal code for \) */
